...
const GROUP_ID = '6a605c7ce4b0772a6279295e' // 830 项目【登顶计划】(test messages are expected here)
...
ok('sender name shown for the sent message', senderShown.some(text => text === '单国鑫'), senderShown.slice(-3).join(','))
